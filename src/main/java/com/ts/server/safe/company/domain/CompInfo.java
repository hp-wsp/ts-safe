...
public class CompInfo {
    ...
    public List<IndCtg> getIndCtgs() {
        return indCtgs;
    }

    public void setIndCtgs(List<IndCtg> indCtgs) {
    ...
    public boolean equals(Object o) {
        ...
        return busStatus == compInfo.busStatus &&
                ...
                Objects.equals(indCtgs, compInfo.indCtgs) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, channelId, name, provinceId, province, cityId, city, countryId, country, address, regAddress, regDate, busStatus, legalPerson, legalPhone, legalMobile, safePerson, safePhone, safeMobile, contact, phone, mobile, creditCode, postCode, indCtgs, indPhone, entScale, indOfCompany, memFun, manProduct, profile, images, updateTime, createTime);
    }
     ...
     * 行业分类
     */
    public static class IndCtg {
        @ApiModelProperty("行业分类编号")
        private String id;
