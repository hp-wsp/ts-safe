...
import com.ts.server.safe.base.controller.logger.UniSpeIndustryLogDetailBuilder;
...
public class UniSpeIndustrySysController {
    ...
    @EnableApiLogger(name = "新增特种行业", buildDetail = UniSpeIndustryLogDetailBuilder.SaveBuilder.class)
    @ApiOperation("新增特种行业")
    ...
    @EnableApiLogger(name = "修改特种行业", buildDetail = UniSpeIndustryLogDetailBuilder.UpdateBuilder.class)
    @ApiOperation("修改特种行业")
    ...
    @EnableApiLogger(name = "删除特种行业", buildDetail = UniSpeIndustryLogDetailBuilder.DeleteBuilder.class)
    @ApiOperation("删除特种行业")
