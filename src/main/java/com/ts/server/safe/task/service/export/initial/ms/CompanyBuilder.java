 ...
 */
 class CompanyBuilder implements PageBuilder {
    ...
    private void renderInfo(XWPFTable table, InitReportContent report){
        XWPFTableRow row = table.getRow(0);
        XWPFTableCell cell = row.getCell(0);
    ...
    private void renderCompanyPerson(XWPFTable table, InitReportContent report) {
    ...
    private void renderDeclareCtg(XWPFTable table, InitReportContent.CompBaseInfo info){
    ...
    private void renderGreatTable(XWPFTableCell cell, InitReportContent.CompBaseInfo info){
        XWPFParagraph paragraph = cell.getParagraphArray(0);
    ...
    private void renderDetail(XWPFTable table, InitReportContent.CompBaseInfo info){
    ...
    private void renderRisk(XWPFTable table, InitReportContent.CompBaseInfo info){
