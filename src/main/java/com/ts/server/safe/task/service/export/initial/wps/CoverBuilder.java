...
class CoverBuilder implements PageBuilder {
    ...
    private void renderContent(XWPFDocument doc, InitReportContent report){
    ...
    private void renderContentRow1(XWPFDocument doc, InitReportContent report){
    ...
    private void renderContentRow2(XWPFDocument doc, InitReportContent report){
    ...
    private void renderContentRow3(XWPFDocument doc, InitReportContent report){
        XWPFTableRow row = createContentRow(doc,2);
        XWPFTableCell cell = row.getCell(0);
    ...
    private void renderContentRow4(XWPFDocument doc, InitReportContent report){
        XWPFTableRow row = createContentRow(doc,2);
        XWPFTableCell cell = row.getCell(0);
    ...
    private void renderContentRow5(XWPFDocument doc, InitReportContent report){
        XWPFTableRow row = createContentRow(doc,2);
        XWPFTableCell cell = row.getCell(0);
