...
CREATE TABLE IF NOT EXISTS c_channel (
  id CHAR(32) NOT NULL,
  name VARCHAR(30) NOT NULL COMMENT '名称',
  province_id VARCHAR(15) NOT NULL DEFAULT '' COMMENT '省份编号',
  province VARCHAR(25) NOT NULL DEFAULT '' COMMENT '省份',
  city_id VARCHAR(15) NOT NULL DEFAULT '' COMMENT '城市编号',
  city VARCHAR(25) NOT NULL DEFAULT '' COMMENT '城市',
  country_id VARCHAR(15) DEFAULT '' COMMENT '县区编号',
  country VARCHAR(25) DEFAULT '' COMMENT '县区',
