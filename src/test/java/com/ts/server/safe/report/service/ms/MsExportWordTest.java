...
public class MsExportWordTest {
    ...
    private IniReport buildReport(){
        ...
        IniReport.ReportDetail bzDetail = new IniReport.ReportDetail();
        ...
        IniReport.PersonInfo personInfo = new IniReport.PersonInfo();
        personInfo.setPhone("0792-6667839");
        personInfo.setName("测试1");
        personInfo.setMobile("18601689972");
        bzDetail.setChanContact(personInfo);

        IniReport.PersonInfo leader = new IniReport.PersonInfo();
        leader.setPhone("0792-6667839");
        leader.setName("领导1");
        leader.setMobile("");
        bzDetail.setLeader(leader);

        List<IniReport.PersonInfo> workers = new ArrayList<>(3);
        for(int i = 0; i < 3; i++){
            IniReport.PersonInfo worker = new IniReport.PersonInfo();
